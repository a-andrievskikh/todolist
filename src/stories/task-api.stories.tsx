...
export const GetTasks = () => {
  ...
  const onChangeHandler = (e: ChangeEvent<HTMLInputElement>) => getTodolistsID(e.currentTarget.value)
...
export const CreateTask = () => {
  ...
  const onChangeTodolistIDHandler = (e: ChangeEvent<HTMLInputElement>) => getTodolistsID(e.currentTarget.value)
